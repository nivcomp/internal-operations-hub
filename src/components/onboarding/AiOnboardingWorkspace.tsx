...
const COPY = {
  he: {
    ...
    clientIntro: "זו שיחה קצרה ונעימה — לא שאלון. אתם מספרים בקצב שלכם, ואני מסדר את זה לסיכום ברור שממנו אפשר להתחיל לבנות.",
    ...
    progressReady: "הסיכום מוכן לבדיקה",
    progressAria: "התקדמות בשיחה",
    ...
    journeyOneText: "נדבר על העסק, על המטרה ועל מי שישתמש בזה בפועל.",
    journeyTwoTitle: "מסדרים את זה יחד",
    journeyTwoText: "הסיכום נבנה אוטומטית ורק מידע שכבר סיפרתם יופיע בו.",
    journeyThreeTitle: "מתחילים לבנות",
    journeyThreeText: "בסיום נעבור על הסיכום ונכין לכם תצוגה ראשונה של מה שתקבלו.",
  ...
  en: {
    ...
    clientIntro: "This is a relaxed conversation, not a questionnaire. Share things in your own words and I’ll shape them into a clear summary we can start building from.",
    ...
    journeyTwoTitle: "Put it in order together",
    journeyTwoText: "The summary builds gradually and only shows information you have already shared.",
    journeyThreeTitle: "Start building",
    journeyThreeText: "When we finish, we review the summary and prepare a first preview of what you will get.",
